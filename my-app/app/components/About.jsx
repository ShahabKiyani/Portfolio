      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I am an aspiring software engineer. I am a junior at UMASS Amherst
            in the Honors College studying computer science. During my tenure,
            I've involved myself in various courses and clubs, enhancing my
            skillset and network to bring otgether a complete package of a
            developer
          </p>
